const SignUpPage = () => {
  return (
    <>
      <div className="flex justify-center min-h-screen items-center bg-zinc-900 flex-col">
          ...
          <form className=" flex flex-col w-70">
            ...
            <div className="flex justify-center items-center w-70 mt-5">
              <input
                type="submit"
                value={"Sign Up"}
                className=" text-white font-md p-1 bg-zinc-700 w-70 items-center rounded-sm hover:bg-zinc-600"
              ></input>
            </div>
          </form>
        </div>
